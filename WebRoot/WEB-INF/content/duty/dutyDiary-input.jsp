...
<body>
	...
	<form id="inputForm" action="#" method="post">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="1"
			...
			<tr>
				<th height="25" class="ui-widget-header ui-corner-all" colspan="6"><b><c:out
							value="${_create? '增加':'查看'}" />值班日志</b>
				</th>
			</tr>
			...
			<tr>
				...
				<td align="left" colspan="3" class="ui-state-hover" align="right"><textarea
						name="content" id="diaryContent" style="width:100%;height: 200px;"
						class="required">${content}</textarea>
				</td>
			</tr>
			<tr>
				...
				<td height="23" class="ui-widget-header" align="center" colspan="6">
					...
					<button type="reset" id="reset-button">重置</button></td>
			</tr>
		</table>
	</form>
	<script type="text/javascript">

...
<head>
	<title>${appTitle} 系统用户管理-列表</title>
...
<form action="${ctx}/account/user!delete.action" method="post" id="listForm">
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="listTable tableBorder">
	<thead>
	<tr>
	...
	<dataTable:header orderableValues="true,true,true,true,true,false" 
			fieldValues="id,loginName,name,email,role,-"
			labelValues="编号,登录名,姓名,,邮箱,角色,操作"></dataTable:header>
	</thead>
	<tbody>
	...
	<tr>
		...
		<td class="first-cell ui-state-default" width="10%" align="left">
			<div class="ui-button ui-state-active ui-corner-all ui-button-text-only">
				<span class="ui-button-text">${dto.loginName}</span>
			</div>
		</td>
		<td class="ui-state-default" width="10%" align="left">
			<div class="ui-button ui-state-active ui-corner-all ui-button-text-only">
		...
		<td class="ui-state-default" align="left">
			<div class="ui-button ui-state-active ui-corner-all ui-button-text-only">
				<span class="ui-button-text">${dto.email}</span>
			</div>
		</td>				
		<td class="ui-state-default" width="10%" align="left">
			<div class="ui-button ui-state-active ui-corner-all ui-button-text-only">
				<span class="ui-button-text">${dto.roleName}</span>
			</div>
		</td>
		<td class="ui-state-default" align="center" width="120">
     		<a class="edit-button" style="padding: 0px;" href="${ctx}/account/user!input.action?id=${dto.id}" title="编辑">
     			<img src="${ctx}/images/icon_edit.gif" border="0" width="16" height="16" />
     		</a>
     		<a class="delete-button" style="padding: 0px;" href="${ctx}/account/user!delete.action?id=${dto.id}" title="删除">
	...
	<tr>
		<td colspan="6" class="ui-widget-header ui-corner-all" height="25" align="center">		

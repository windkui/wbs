...
<div class="ui-widget-header ui-corner-all" style="padding: 2px;">
   <button id="refresh-button">系统权限管理</button>
   <button id="toolbar-button">工具栏</button>   
</div>
<div id="toolbarPanel" class="ui-corner-all ui-state-default">
	<form id="searchForm" name="searchForm" action="${ctx}/account/authority!list.action" method="post">	
		...
		<tr>
			...
			<td class="ui-state-hover ui-corner-all" colspan="6">
				...
				<button type="button" id="add-button" value="${ctx}/account/authority!input.action">添加</button>
			</td>
		</tr>	
		</tbody>
		</table>
...
<div id="dataPanel" class="dataPanel" align="center">
	<div id="inputDialog" title="系统权限" style="background: transparent;">
...
function initPageUI() {
	jQuery(window).initDataPagerUI({
		gridConfig: {
			width: '50%',
			colModel: [
				{header:'权限名', name: 'name', width: 100, sort:'clientSide'},
